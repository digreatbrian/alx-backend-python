...
class TestGithubOrgClient(unittest.TestCase):
    ...
    def test_org(self, input, mock):
        ...
        Args:
            input (str): The name of the GitHub organization.
            mock (Mock): Mock object for get_json.
        """
    ...
    def test_public_repos(self, mock_json):
        ...
        Args:
            mock_json (Mock): Mock object for get_json.
        """
    ...
    def test_has_license(self, repo, license_key, expected):
        ...
        Args:
            repo (Dict[str, Dict]): Repository information.
